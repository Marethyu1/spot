...
export const createImageUrl = (options) => {
    return _createAnyImageUrl(options)
}

export const createPinUrl = (options) => {
    return _createAnyImageUrl(options, "pin")
}

export const createThumbnailUrl = (options) => {
    return _createAnyImageUrl(options, "thumbnail")
}
